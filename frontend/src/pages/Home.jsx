    ...
    return (
        <main className="min-h-screen overflow-hidden bg-[#020617] text-white selection:bg-cyan-300/20">
            ...
            <header className="relative z-20 mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
                ...
                <Link to="/chat" className="group hidden items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-cyan-600 transition hover:-translate-y-0.5 hover:bg-slate-100 sm:flex">Start learning <ArrowRight size={15} className="transition group-hover:translate-x-1"/></Link>
            </header>
