...
function AdaptiveRoute({ authenticated, demo, account }) {
    ...
    useEffect(() => {
        const labels = { "/": user ? "Your learning space" : "Learn smarter", "/chat": "Learn", "/translate": "Translation", "/dashboard": "Dashboard", "/analytics": "Analytics", "/settings": "Settings", "/about": "About Nova" };
...
export default function App() {
    useEffect(() => { installApiCompatibility(); }, []);
